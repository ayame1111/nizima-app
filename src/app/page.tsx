            ...
            {products.map((product) => (
              <div key={product.id} className="group bg-white rounded-2xl overflow-hidden hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100 flex flex-col h-full">
                ...
                <div className="relative aspect-[4/5] bg-gray-100 overflow-hidden">
                    ...
                    {/* Like Button */}
                    <button className="absolute top-3 right-3 z-20 p-2 bg-white/90 rounded-full text-gray-400 hover:text-red-500 hover:bg-white transition-all shadow-sm opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 duration-300">
                        <Heart size={16} />
                    </button>
